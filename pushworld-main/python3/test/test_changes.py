...
menv = RewardWrapper(menv, scale=1.0, shift=0.0, clip=None)
...
eval_env = RewardWrapper(eval_env, scale=1.0, shift=0.0, clip=None)
...
def test_model(model):
    ...
    test_env = RewardWrapper(test_env, scale=1.0, shift=0.0, clip=None)
    num_episodes = 200
