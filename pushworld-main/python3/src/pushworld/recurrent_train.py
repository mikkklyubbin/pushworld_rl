...
from pushworld.model import CustomCNN, CustomPolicy, train_ppo, train_rec_PPO
...
model = train_rec_PPO(menv, combined_callback, **config_train, model_kwargs=model_kwargs)
